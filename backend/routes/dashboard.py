...
async def get_dashboard_stats(user: dict = Depends(get_current_user)):
    async with deps.pool.acquire() as conn:
        ...
        return {
            "total_products": total_products, "selected_for_odoo": selected_products,
            "selected_for_lightspeed": selected_lightspeed, "synced_to_odoo": synced_products,
            "total_suppliers": total_suppliers, "active_suppliers": active_suppliers,
            "pending_products": pending_products, "total_variants": total_variants,
